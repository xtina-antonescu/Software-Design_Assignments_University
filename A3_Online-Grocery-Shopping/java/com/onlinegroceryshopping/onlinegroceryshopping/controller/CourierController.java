...
public class CourierController {
    ...
    public ResponseEntity<Delivery> acceptDelivery(@RequestParam("id") Integer id,@RequestParam("email") String email, @RequestParam("password") String password){
        Courier courier = courierService.authenticate(email, password);
        try{
            if(courier.getAuthenticated()){
                ...
                deliveryNotification.notifyObservers();
