...
public class ProviderController {
    ...
    public ResponseEntity<Product> updateProduct(@RequestParam("id")Integer id, @RequestBody Product product, @RequestParam("email") String email, @RequestParam("password") String password){
        Provider provider = providerService.authenticate(email, password);
        try{
            if(provider.getAuthenticated()){
